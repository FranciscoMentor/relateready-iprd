...
const REFERRAL_MESSAGE = {
  es: "Antes que cualquier otra cosa: gracias por responder con tanta honestidad, incluso en las partes más difíciles. Eso no es fácil, y dice mucho de tu valentía.\n\nAl leer tus respuestas, algo nos dice que es posible que estés atravesando un momento particularmente difícil — y queremos que sepas que no tienes que atravesarlo solo/a. Lo que compartiste merece ser acompañado por alguien con la formación adecuada para sostenerlo, más allá de lo que este test puede ofrecerte.\n\nTe animamos, con cariño y sin ninguna prisa que te haga sentir presión, a buscar apoyo de un profesional de salud mental — un psicólogo, terapeuta o consejero — o de alguien de confianza en tu vida, lo antes posible. Pedir ayuda en un momento así no es una señal de debilidad; es uno de los actos más valientes y responsables que puedes hacer por ti mismo/a.\n\nSi en algún momento sientes que estás en crisis o en peligro inmediato, por favor contacta a una línea de emergencia o de prevención de tu país, o acude a un servicio de urgencias, sin esperar.",
  en: "Before anything else: thank you for answering so honestly, even in the hardest parts. That isn't easy, and it says a lot about your courage.\n\nAs we read your answers, something tells us you may be going through a particularly difficult time right now — and we want you to know you don't have to go through it alone. What you shared deserves to be held by someone with the right training to support it, beyond what this test can offer.\n\nWe warmly encourage you, with no pressure at all, to reach out to a mental health professional — a psychologist, therapist, or counselor — or to someone you trust in your life, as soon as you can. Asking for help in a moment like this isn't a sign of weakness; it's one of the most courageous and responsible things you can do for yourself.\n\nIf at any point you feel you're in crisis or in immediate danger, please contact a crisis or emergency line in your country, or go to an emergency service, right away.",
};
