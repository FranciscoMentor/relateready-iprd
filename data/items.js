// Banco de ítems del IPRD — 48 ítems núcleo (6 por dimensión × 8 dimensiones),
// 6 ítems de control de deseabilidad social, 3 preguntas cualitativas opcionales.
// Fuente: IPRD_banco_de_items.xlsx (Fase B). Redacción 100% original.
//
...
const CORE_ITEMS = {
  AS: [
    ...
    { keying: "R", es: "Cuando no tengo noticias de alguien que me gusta por unas horas, empiezo a imaginar que algo salió mal.", en: "When I don't hear from someone I like for a few hours, I start imagining something went wrong." },
  ...
  DS: [
    { keying: "D", es: "Puedo sostener una opinión distinta a la de alguien que me importa sin sentir que eso pone en riesgo el vínculo.", en: "I can hold an opinion different from that of someone I care about without feeling it puts the bond at risk." },
  ...
  RS: [
    ...
    { keying: "D", es: "Una respuesta corta o seca de alguien no me hace dudar de inmediato de todo el vínculo.", en: "A short or dry reply from someone doesn't immediately make me doubt the whole relationship." },
  ...
  CG: [
    ...
    { keying: "R", es: "Prefiero terminar una relación ante la primera dificultad importante antes que invertir tiempo en resolverla.", en: "I'd rather end a relationship at the first major difficulty than invest time in working through it." },
  ],
  CR: [
    ...
    { keying: "R", es: "Me cuesta ser el/la primero/a en dar el paso de reconciliación después de una pelea.", en: "I find it hard to be the first one to reach out after a fight." },
  ],
  AR: [
    ...
    { keying: "R", es: "Cuando una relación termina, siento que una parte importante de mi valor como persona se va con ella.", en: "When a relationship ends, I feel like an important part of my worth as a person goes with it." },
  ],
  IA: [
    ...
    { keying: "D", es: "Puedo hablar de mis experiencias pasadas difíciles sin necesidad de esconderlas para dar una buena impresión.", en: "I can talk about difficult past experiences without hiding them to make a good impression." },
  ...
  CV: [
    ...
    { keying: "D", es: "Antes de involucrarme con alguien, tengo una idea clara de mis propias prioridades de vida (trabajo, familia, estilo de vida).", en: "Before getting involved with someone, I have a clear idea of my own life priorities (work, family, lifestyle)." },
